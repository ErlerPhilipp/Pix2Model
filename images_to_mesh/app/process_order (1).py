...
# from images_to_mesh.processing_steps.mesh_reconstruction_texturing.textured_reconstruction import process_clouds
...
@task(2)
def _mesh_reconstruction_texturing(*args, **kwargs):
    connection = Redis(host="redis")
    current_job  = get_current_job(connection)
...
@task(2)
def _mesh_reconstruction_texturing_without_dependency(*args, **kwargs):
