...
function About(props) {
    return (
        <div class='content about'>
            <div class='team'>
                <h2>Project team</h2>
                <big>Stefan Ohrhallinger</big>
                <img src='stefan.jpeg' class='team_images'></img>
                <big>Philipp Erler</big>
            ...
            <div className='wrapper_centered_box text'>
                ...
                generalization performance and reconstruction accuracy.<br></br><br></br>
                ...
                Our source code, pre-trained model, and dataset are available on: <a href="url">https://github.com/ErlerPhilipp/points2surf</a></p>
            </div>
        </div>
    );
}
